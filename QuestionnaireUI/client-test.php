...
<body>
	...
	<form id="form" >
		...
		<li name="1.1age">
			...
			<input type="radio" name="A1" value="1" required111><?php echo gettext("15岁以下"); ?><br/>
		...
		<li name="1.2sex">
			...
			<input type="radio" name="A2" value="1" required111> <?php echo gettext("男"); ?>
		...
		<li name="1.3client_id">
			...
			<input type="radio" name="A3" value="1" required111> <?php echo gettext("医药卫生"); ?>&nbsp;
		...
		<li name="2.1wifi_request">
			...
			<input type="radio" name="B1" value="1" required111> <?php echo gettext("有"); ?>	<br/>
		...
		<li name="2.2using_way"  >
			...
			<input type="radio" name="B2a" value="1" required111 onchange="isDisplay()"> <?php echo gettext("向顾客公开您的wifi密码"); ?>	<br/>
			...
			<input id="display" type="text" name="B2b" maxlength="100" style="display:none;" required111 	> <br/>
		</li>
		<li name="2.3info_security">
			<span style="color: #ff0000;"> <?php echo gettext("在给顾客提供网络的同时，您是否会担心自己的信息安全性？"); ?></span><br/>
			<input type="radio" name="B3" value="1" required111> <?php echo gettext("完全不担心"); ?>	<br/>
		...
		<li name="2.4info_against">
			...
			<input type="radio" name="B4" value="1" required111> <?php echo gettext("是"); ?>	<br/>
		...
		<li name="3.1number_control">
			...
			<input type="radio" name="C1" value="1" required111> <?php echo gettext("希望"); ?>	<br/>
		...
		<li name="3.2make_own_value_add">
			...
			<input type="radio" name="C2" value="1" required111> <?php echo gettext("希望"); ?>	<br/>
		...
		<li name="3.3publish_own_adv">
			...
			<input type="radio" name="C3" value="1" required111> <?php echo gettext("希望"); ?>	<br/>
		...
		<li name="3.4adv_push">
			...
			<input type="radio" name="C4" value="1" required111> <?php echo gettext("希望"); ?>	<br/>
		...
		<li name="3.5cooperation">
			...
			<input type="radio" name="C5" value="1" required111> <?php echo gettext("愿意"); ?>	<br/>
		...
		<li name="3.6open_adv_right">
			...
			<input type="radio" name="C6" value="1" required111> <?php echo gettext("愿意"); ?>	<br/>
		...
		<li name="3.7push_discount_service">
			...
			<input type="radio" name="C7" value="1" required111> <?php echo gettext("愿意"); ?>	<br/>
	...
	<script type="text/javascript">
    	...
    	var url = "libs/business.php"; 
    	 $.ajax({
           ...
           {
              window.location.href='ui_thanks.php';
           }
         });
    	return false; 
		});
