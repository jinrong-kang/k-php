...
<body>
	<form method="post" action="ui_user.php">
			<input type="image" name="language" value="english" src="images/gb.png" alt="Submit" align="right" style="margin:5px;" > 
			<input type="image" name="language" value="french" src="images/fr.png" alt="Submit" align="right" style="margin:5px"> 
	...
	<form id="form"  method="post" action="ui_thanks.php" " >
		...
		<li name="user_id">
			...
			<input type="radio" name="A3" value="1" required> <?php echo gettext("在职员工"); ?>	<br/>
		...
		<li name="2.using_way">
			...
			<input type="radio" name="B2a" value="1" required onchange="is_display()" > <?php echo gettext("向店家询问他的wifi密码"); ?>	<br/>
			<input type="radio" name="B2a" value="2" onchange="is_display()" > <?php echo gettext("使用登录平台直接进行网络连接"); ?><br/>
			<input type="radio" name="B2a" value="3" onchange="is_display()" > <?php echo gettext("其它（请说明）："); ?><br/>
			<input id="display" type="text" name="B2b" maxlength="100" style="display:none;" > <br/>
		</li>
		...
		<li name="5.using_time">
			...
			<input type="radio" name="B5" value="1" required> <?php echo gettext("30分钟以下"); ?>	<br/>
		...
		<li name="6.if_has_wifi">
			...
			<input type="radio" name="B6" value="1" required> <?php echo gettext("是"); ?>	<br/>
		...
		<li name="7.time_extend">
			...
			<input type="radio" name="B7" value="1" required> <?php echo gettext("是"); ?>	<br/>
		...
		<li name="2.video_adv_time">
			...
			<input type="radio" name="C2" value="1" required> <?php echo gettext("10秒以内"); ?>	<br/>
		...
		<li name="3.relogin_after_30mins">
			...
			<input type="radio" name="C3" value="1" required> <?php echo gettext("会"); ?>	<br/>
		...
		<li name="4.click_interesting_info">
			...
			<input type="radio" name="C4" value="1" required> <?php echo gettext("会"); ?>	<br/>
		...
		<li name="5.accept discount info">
			...
			<input type="radio" name="C5" value="1" required> <?php echo gettext("能"); ?>	<br/>
