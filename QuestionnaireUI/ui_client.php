...
<head>
	...
	<script type="text/javascript">
		...
		function check() {
			...
			{
				alert(liTags.length);
				var inputTags = liTags[i].getElementsByTagName("input");
				...
				if (flag == -1)
				{
					// document.getElementById("span").innerHTML="please select radio";
...
<body>
	...
	<form id="form" >
		...
		<li name="1.1age">
			...
			<input type="radio" name="A1" value="1" ><?php echo gettext("15岁以下"); ?><br/>
			...
			<input type="radio" name="A1" value="6"><?php echo gettext("55岁以上"); ?><br/><span id="span"></span><br/>
		</li>
		<li name="1.2sex">
